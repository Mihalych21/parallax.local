...
$this->title = 'Детские комнаты на заказ в Чебоксарах от '.Yii::$app->params['company'] . $page;
...
<div class="galery-small container">
    <h1 class="header_shadow text-center" >Детские комнаты на заказ от <i><?= Yii::$app->params['company'] ?></i></h1>
    <?php
    $delay = 0.1;
    ?>
