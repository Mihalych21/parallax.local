...
$this->title = 'Офисная мебель на заказ в Чебоксарах от '.Yii::$app->params['company'] . $page;
...
<div class="galery-small container">
    <h1 class="header_shadow text-center" >Офисная мебель на заказ от <i><?= Yii::$app->params['company'] ?></i></h1>
    <?php
    $delay = 0.1;
    ?>
